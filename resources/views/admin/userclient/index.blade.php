...
@section('title','User')
@section('content')
<h2 style="width: 100%">User Client listings </h2>
<a href="{{route('userclient.create')}}" type="button" class="btn btn-primary">Add new</a>
		...
		<tbody>
			...
			<tr>
				...
				<td width="120">
					...
					<a href="{{route('userclient.edit',$user->id)}}"><i class="far fa-edit"></i></a>
					<a href="{{route('userclient.show',$user->id)}}" class="ml-2"><i class="fas fa-info-circle"></i></a> 
				</td>
			</tr>
			@endforeach
		</tbody>
